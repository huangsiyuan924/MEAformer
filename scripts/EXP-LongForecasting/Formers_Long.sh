...
#    --itr 1 >logs/LongForecasting/$model_name'_electricity_'$pred_len.log
  ...
  python -u run_longExp.py \
    ...
    --des 'Exp' \
    --itr 1 \
    --train_epochs 3 >logs/LongForecasting_formers/$model_name'_traffic_'$input_len'_'$pred_len.log

  python -u run_longExp.py \
    --is_training 1 \
    --root_path ./dataset/weather/ \
    --data_path weather.csv \
    --model_id weather'_'$input_len'_'$pred_len \
    --model $model_name \
    --data custom \
    --features M \
    --seq_len $input_len \
    ...
    --des 'Exp' \
    --itr 1 \
    --train_epochs 2 >logs/LongForecasting_formers/$model_name'_weather_'$input_len'_'$pred_len.log
